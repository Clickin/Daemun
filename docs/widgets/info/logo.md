...
This allows you to display the Daemun logo. You can optionally specify your own icon using similar options as other icons; see [service icons](../../configs/services.md#icons).
