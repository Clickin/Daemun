...
export default function Error({ error }) {
  ...
  if (typeof error === "string") {
    error = { message: error }; // oxlint-disable-line no-param-reassign
  } else if (typeof error === "number") {
    error = { message: `Error ${error}` }; // oxlint-disable-line no-param-reassign
  }

  if (error?.data?.error) {
    error = error.data.error; // oxlint-disable-line no-param-reassign
  }
